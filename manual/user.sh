...
# 4 - try to access /users as role: user
...
# 5 - try to access /users as role: admin
curl -X GET "http://localhost:4000/users" \
  -H "Authorization: Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIiwic2NwIjoidXNlciIsImF1ZCI6bnVsbCwiaWF0IjoxNzM4NDIwMTk5LCJleHAiOjE3Mzg0MjM3OTksImp0aSI6IjU1MTg0ZTBiLWYzYjctNDUyZC04ZDNmLTYzODlmZmNhNzgzYSJ9.ENaAjgYo_T91Nso31cQrlYPnhU-N-OQ1RRoRK8lMKGc" \
  | jq .
[
  {
    "id": 1,
